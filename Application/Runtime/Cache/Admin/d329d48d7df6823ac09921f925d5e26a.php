...
<article class="page-container">
	<form action="" method="post" class="form form-horizontal" id="form-change-password">
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9"> <?php echo ($data["username"]); ?> </div>
		</div>
		<div class="row cl">
		...
		<input type="hidden" name="change_id" value="<?php echo ($data["id"]); ?>">
	</form>
</article>
...
$(function(){
	$("#form-change-password").validate({
		...
		submitHandler:function () {
            ...
            $.post("<?php echo U('member/changepwd');?>",postData,function (data) {
