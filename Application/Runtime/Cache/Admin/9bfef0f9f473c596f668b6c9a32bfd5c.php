...
<table class="table">
	<tr>
		<td width="200" class="va-t">
			...
			<ul class="ztree">
				<?php if(is_array($dataslist)): foreach($dataslist as $key=>$d): ?><li style="background-color: #00b7ee;height: 40px;font-weight: 700;font-size: 14px;line-height: 40px;border: 1px solid #666;" title="<?php echo ($d["category_name"]); ?>"><?php echo (str_repeat('&nbsp;',$d["level"]*9)); ?>
		...
		<td class="va-t"><iframe ID="testIframe" Name="testIframe" FRAMEBORDER=0 SCROLLING=AUTO width=100%  height=390px SRC="<?php echo U('add');?>"></iframe></td>
	</tr>
</table>
<!--_footer 作为公共模版分离出去-->
